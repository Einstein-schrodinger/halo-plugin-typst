// typst-resource-mapper.ts
import { TypstImageMapper } from './typst-image-mapper';
import { TypstDataMapper } from './typst-data-mapper';
import { TypstTypMapper } from './typst-typ-mapper';
...
export class TypstResourceMapper {
  private imageMapper: TypstImageMapper;
  private dataMapper: TypstDataMapper;
  private typstMapper: TypstTypMapper;
  ...
  async processTypstCode(typstCode: string): Promise<ResourceMappingResult> {
...
export async function processTypstResources(typstCode: string): Promise<ResourceMappingResult> {
